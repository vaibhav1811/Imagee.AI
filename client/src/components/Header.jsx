...
//used framer motion and imported it for the animation by  "npm install motion" and going through its documentation 
...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      initial={{opacity:0}}
      animate={{opacity:1}}
      duration={{delat:0.4, duration: 2}}
      >image</span>, in seconds.</motion.h1>

      <motion.p className='text-center max-w-xl mx-auto mt-5'
       initial={{opacity:0,y:20}}
      animate={{opacity:1,y:0}}
      duration={{delat:0.6, duration: 0.8}}
      >Turn Your ideas into visual art in a click- just type,and enjoy the magic
      </motion.p>
      ...
      <motion.button onClick={onClickHandler} className='sm:text-lg text-white bg-black w-auto mt-8 px-12 py-2.5
       ...
       > Genarate Images <img className='h-5' src={assets.star_group} alt="" />
       </motion.button>

      <motion.div 
       initial={{opacity:0}}
      animate={{opacity:1}}
      duration={{delat:1, duration:1}}
      ...
      <motion.p 
       initial={{opacity:0}}
      animate={{opacity:1}}
      duration={{delat:1.2, duration: 0.8}}
