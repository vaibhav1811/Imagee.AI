    ...
    viewport={{once:true}}
        className='relative bg-white p-10 rounded-xl text-slate-500'>
           ...
           { state!== 'Login' &&
            ...
            <div onChange={e => setEmail(e.target.value)} value={email} className='border px-6 py-2 flex items-center gap-4 rounded-full mt-5'>
                <img  src={assets.email_icon} alt="" />
                <input className=' outline-none text-sm ' type="email" placeholder='Email id' required />
            </div>

            <div onChange={e => setPassword(e.target.value)} value={password} className='border px-6 py-2 flex items-center gap-4 rounded-full mt-4'>
            ...
            {state === 'Login'?<p className='mt-5 text-center'>
              ...
              :
                ...
                className='absolute top-5 right-5 cursor-pointer' alt="" />
        </motion.form>
